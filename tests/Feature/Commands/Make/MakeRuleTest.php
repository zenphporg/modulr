...
test('it scaffolds a rule in the module when module option is set', function (): void {
...
test('it scaffolds a rule in the app when module option is missing', function (): void {
  $command = MakeRule::class;
  $arguments = ['name' => 'TestRule'];
